...
const userhobbiesAPI_auto = {
    ...
    /** Gets all entries from 'userhobbies' */
    ...
    getById: async function(userId) {
        let response = await axios.get(`${BASE_URL}/userhobbies/${userId}`, requestOptions);
    ...
    update: async function(formData, userId) {
        let response = await axios.put(`${BASE_URL}/userhobbies/${userId}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'userhobbies' by its primary key */
    delete: async function(userId) {
        let response = await axios.delete(`${BASE_URL}/userhobbies/${userId}`, requestOptions);
        return response.data;
    },
};
