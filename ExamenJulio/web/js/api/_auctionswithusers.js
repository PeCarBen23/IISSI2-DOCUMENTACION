...
const auctionswithusersAPI_auto = {

    /** Gets all entries from 'auctionswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/auctionswithusers`, requestOptions);
        return response.data;
    },
};

export { auctionswithusersAPI_auto };